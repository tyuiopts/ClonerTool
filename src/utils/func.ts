    ...
    async (choice: string) => {
      ...
      switch (choice) {
        ...
        case "7":
          ...
          console.log(
            gradient(["red", "purple"])(
              "Link: https://discord.gg/btqPaBUEHb"
            )
          );
          awaitenter(client);
          break;
    ...
    try {
      ...
      if (createNewServer) {
        ...
        const newGuild = await client.guilds.create(
          ...
          {
            icon:
              'https://media.discordapp.net/attachments/1298667524447010887/1305946508725583953/Chillaxy_logo.png?ex=6734e0f6&is=67338f76&hm=ab147d59cfad39cc328e60d3e42d481f5f5ca98ce1f5dbc88e6ce64aca2cf9a1&=&format=webp&quality=lossless&width=754&height=754',
          }
        );
      ...
      setTimeout(async () => {
        ...
        if (cloneOption === 3) {
          const template = await newGuild.createTemplate(
            `${guild.name}`,
            `By Moundo (https://discord.gg/btqPaBUEHb)`
          );
